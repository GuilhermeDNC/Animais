...
namespace Animais.Estrutura.Arvore
{
    public class ArvoreBin
    {
        ...
        public ArvoreBin(IComparer comparador)
        {
        ...
        public void Insere(Animal valor) // insere um valor int
        {
            ...
            else
            {
                ...
                if (no_aux.EhInterno())
                {
                    throw new NomeRepetidoException("Este valor já existe na árvore!!!!");
                }
            }
        ...
        private void PercursoInterfixado(Nodo no)
        {
            ...
            lista.InserirNoFim(no.GetValor());
                                   ...
                                   Nodo no)
        {
            if (no == null)
                ...
                return PesquisaValor(chave, no.GetNoEsquerda());
        }
        ...
        public void Remove(object chave)
        {
            ...
            Nodo noQueSeraApagado = PesquisaValor(chave, raiz);
        ...
        public bool Pesquisa(object chave)
        {
            Nodo nodo = PesquisaValor(chave, raiz);
